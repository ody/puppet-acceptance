...
mkdir -p /tmp/puppet-$$-master/pro/manifests \
  /tmp/puppet-$$-master/pro/modules/envs/manifests \
  /tmp/puppet-$$-master/pro/modules/envs/lib \
...
cat <<ENVSITE1 > "/tmp/puppet-$$-master/pro/manifests/site.pp"
${ENVSITE}
ENVSITE1

cat <<ENVPRO > "/tmp/puppet-$$-master/pro/modules/envs/manifests/init.pp"
${ENVPRO}
ENVPRO
